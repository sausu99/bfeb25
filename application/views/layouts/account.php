    ...
    <div class="hero-section style-2 pb-lg-400">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo $this->general->lang_uri('/my-account/user/index'); ?>"><?php echo lang("account_my_account");?></a>
                </li>
                <li>
                ...
                <div class="col-sm-10 col-md-7 col-lg-4">
                    <div class="dashboard-widget mb-30 mb-lg-0">
                        ...
                        <ul class="dashboard-menu">
                            <li><a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/index') ?>"  <?php if($account_menu_active=='dashboard') echo 'class="active"'; ?>><i class="flaticon-dashboard"></i><?php echo lang("account_dashboard");?></a>
                            </li>
                            <li><a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/edit') ?>" <?php if($account_menu_active=='profile') echo 'class="active"'; ?>><i class="flaticon-user"></i><?php echo lang("account_personal_profile");?> </a>
                            </li>
                            <li><a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/mobile') ?>" <?php if($account_menu_active=='moible') echo 'class="active"'; ?>><i class="flaticon-user"></i><?php echo lang("account_personal_mobile");?> </a>
                            </li>
                            <?php if($this->session->userdata(SESSION.'social_id')==""){?>
                            <li><a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/changepassword') ?>" <?php if($account_menu_active=='password') echo 'class="active"'; ?>><i class="flaticon-user"></i><?php echo lang('account_change_pass');?></a>
                            </li>
                            <?php }?>
                            <li>
                                <a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/buybids') ?>" <?php if($account_menu_active=='buybids') echo 'class="active"'; ?>><i class="flaticon-bidcredit"></i><?php echo lang("account_my_bid_credit");?> </a>
                            </li>
                            ...
                            <li>
                                <a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/wonauctions') ?>" <?php if($account_menu_active=='wonauctions') echo 'class="active"';?>><i class="flaticon-best-seller"></i><?php echo lang("account_winning_bid");?></a>
                            </li>
  ...
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="m_0 text-left"><?php echo lang("account_image_upload");?></h6>
      ...
      <div class="modal-body">
        ...
        <div class="action">
          ...
          <label for="file-input"><?php echo lang("account_choose_file");?></label>
          <p id="actions" style="display:none;">
            <button type="button" id="edit" class="btn_crop" style="display:none;"><?php echo lang("label_edit");?></button>
            <button type="button" id="crop" class="btn_crop"><?php echo lang("label_done");?></button>
          </p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger main_btn single_bt" data-dismiss="modal"><?php echo lang("label_cancel");?></button>
      </div>
    </div>
  </div>
</div>
