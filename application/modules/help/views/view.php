...
<div style="padding:6px 20px; float:left; width:610px; background:#202020; color:#ABABAB;"><span class="breed"><a href="<?=site_url(ADMIN_DASHBOARD_PATH)?>">ADMIN</a> &raquo; Help  Management </span></div>
    ...
    <div class="mid_frm">
      ...
      <table width="100%">
        <tr>
          <td>
		  <ul id="vList">
		   <li>[ <a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/help/add_help">Add Help</a> ]</li>
		   <?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="contentbl">
  <tr> 
  <th width="40%" align="left">Help Title </th>
  ...
  <tr> 
	...
	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/help/edit_help/<?php print($lang_id);?>/<?php print($data->id);?>" style="margin-right:5px;">
      <img src='<?php print(ADMIN_IMG_DIR_FULL_PATH);?>/edit.gif' title="Edit"></a>   <a  style="margin-left:5px;" href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/help/delete_help/<?php print($lang_id);?>/<?php print($data->id);?>">
