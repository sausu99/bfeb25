...
<p class="mt-2"><?php echo lang('label_checkout_desc_text');?></p>
    ...
    if($this->session->flashdata('success_message'))
      ...
      <div role="alert" class="alert alert-success alert-dismissible fade show">
                    ...
                    <span class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <p><span id="bid_error"><?php echo $this->session->flashdata('success_message') ?></span></p>
        ...
        <div class="row">
          <div class="col-md-12 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
              <span class="text-muted"><?php echo lang('label_payment_details');?></span>
            ...
            <ul class="list-group mb-3">
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                ...
                <span class="text-muted"><?php echo $this->general->default_formate_price_currency_sign($auc_lists->buy_now_price,'<span>','</span>');?></span>
              </li>
              ...
              <li class="list-group-item d-flex justify-content-between">
                ...
                <strong><?php echo $this->general->default_formate_price_currency_sign($auc_lists->buy_now_price+$auc_lists->shipping_cost,'','');?></strong>
              </li>
            </ul>
          ...
          <form id="shipping_info" name="shipping_info" class="login-form" method="post" action="">
        		<?php $total_cost = $auc_lists->buy_now_price+$auc_lists->shipping_cost;?>
        <input type="hidden" name="transaction_type" value="buy_auction" />
<input type="hidden" name="auc_win_id" value="" />
<input type="hidden" name="product_id" value="<?php echo $auc_lists->product_id;?>" />
<input type="hidden" name="amount" value="<?php echo $auc_lists->buy_now_price;?>" />
...
<input type="hidden" name="credit_used" value="<?php echo $total_bids_placed*BUY_NOW_BID_REWARD_TIMES;?>" />
...
<input name="payment_type" id="payment_type" type="hidden" value="<?php echo $payment_type;?>" />
             ...
             <hr class="mb-4">
              <div class="row">
                ...
                <div class="col-sm-6 col-xs-6">
                  ...
                  <div class="form-group checkgroup mb-30">
                            ...
                            <label for="check">
                                <small><em><?php echo lang('label_ship_bill_same_txt');?></em></small>
                            </label>
                        </div>
        	  ...
        	  <hr>
              <button  class="btn btn-primary btn-sm"><?php echo lang('label_continue_checkout');?></button>
