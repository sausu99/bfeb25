 ...
 <div class="row">
                        <div class="col-12">
                            <div class="dash-pro-item mb-30 dashboard-widget">
                                <div class="header">
                                    <h4 class="title"><?php echo lang('account_personal_mobile');?></h4>
                            ...
                            <div class="col-md-12 mb-3" align="center" <?php echo $verify_field;?> >
                                <em><?php echo sprintf(lang('label_u_did_nt_get_otp'), '<a href="'.$this->general->lang_uri('/'.MY_ACCOUNT.'/user/send_verification_code').'">', '</a>');?></em>
                              </div>
                        </div>
