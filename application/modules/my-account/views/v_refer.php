<div class="dashboard-widget mb-30">
                        <h4 class="title mt-0 mb-20"><?php echo lang('label_refer_title');?></h4>
                        <p><?php echo lang('label_refer_desc_txt');?></p>
                    </div>
                    <div class="dashboard-widget mb-30">
                        <h5 class="title mt-0 mb-20"><?php echo lang('label_refer_share_link');?></h5>
                        <form action="#0" class="referral-form mb-30">
                            ...
                            <button type="button" onclick="myFunction()" class="custom-button"><?php echo lang('label_refer_copy_link');?></button>
                        </form>
                        <div class="share-area">
                            <div class="left">
                                <?php echo lang('label_refer_share');?> :
                            </div>
                    ...
                    <div class="dashboard-widget mb-30">
                        <h5 class="title mt-0 mb-30"><?php echo lang('label_refer_promotions_rewards');?></h5>
