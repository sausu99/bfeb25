    ...
    <div class="hero-section style-2">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>
                    <span><?php $srch = $this->input->get('srch'); if($srch){ echo lang('label_search');}else { echo lang('live_auctions');}?></span>
                </li>
            </ul>
        </div>
    ...
    <div class="product-auction padding-bottom">
        ...
        <div class="section-header-3">
                <div class="left d-block">
                    <h2 class="title mb-3"><?php $srch = $this->input->get('srch'); if($srch){ echo lang('label_search_by').' <small>'.$srch.'</small>';}else { echo lang('live_auctions');}?></h2>
