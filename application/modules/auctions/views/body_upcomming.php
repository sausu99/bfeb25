    ...
    <div class="hero-section style-2">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>
                    <span><?php echo lang("label_upcomming_auc");?></span>
                </li>
            </ul>
        </div>
    ...
    <div class="product-auction padding-bottom">
        ...
        <div class="section-header-3">
                <div class="left d-block">
                    <h2 class="title mb-3"><?php echo lang("label_upcomming_auc");?></h2>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2">
                        ...
                        <div class="auction-content">
                            ...
                            <div class="text-center">
                                <a href="<?php echo $this->general->lang_uri('/upcomming/' . $this->general->clean_url($auc_data->name). '-' . $auc_data->product_id); ?>" class="custom-button"><?php echo lang("label_view_details");?></a>
                            </div>
                        </div>
                    </div>
                </div>
