...
<tr>
  ...
  <td>
      <input type="radio" name="best_tag" value="0" checked>None
      <input type="radio" name="best_tag" value="1">Best Selling
      <input type="radio" name="best_tag" value="2">Best Value
  </td>
</tr>
<tr>
  <td class="hmenu_font">Amount</td>
  <td><input name="amount" type="text" class="inputtext" id="amount" value="<?php echo set_value('amount');?>" size="10" />
...
<tr>
 ...
 <tr>
  ...
  <td width="429"><input name="bonus_points" type="text" class="inputtext" id="bonus_points" value="<?php echo set_value('bonus_points');?>" size="10" />
