...
<!--============= Hero Section Starts Here =============-->
    <div class="hero-section">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>
                    <span><?php echo lang("sign_up");?></span>
                </li>
    ...
    <section class="account-section padding-bottom">
            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header">
                        <h2 class="title"><?php echo lang("sign_up");?></h2>
                        <p><?php echo lang("signup_short_desc");?></p>
                    </div>
                    <ul class="login-with">
                        <li>
                            <a href="javascript:void(0);" onclick="return facebookLogin();"><i class="fab fa-facebook"></i><?php echo lang("signup_facebook");?></a>
                        </li>
                        <li>
                        <?php /*?><div id="gSignIn"></div><?php */?>
                            <a href="javascript:void(0);" onclick="return googlelogin();"><i class="fab fa-google-plus"></i><?php echo lang("signup_google");?></a>
                        </li>
                    </ul>
        ...
        <i class="fa fa-warning">&nbsp;</i><span id="error_message"></span></div>
                    ...
                    <h4 class="mb-3"><?php echo lang("profile_personal_details");?></h4>
                    <div class="row">
                    
              <div class="col-md-6 mb-3">
                <label for="firstName"><?php echo lang("register_gender");?></label>
                <select name="gender" class="form-control" id="gender" required>
                    <option value="" selected="selected"><?php echo lang("register_select_gender");?></option>                    
                    <option value="M"><?php echo lang("register_gender_male");?></option>
            ...
            <div class="row">
                ...
                <h4 class="mb-3"><?php echo lang("reg_login_details");?></h4>
                        ...
                        <div class="form-group checkgroup">
                            ...
                            <label for="check">
                                <?php echo lang("register_terms_condition_info_txt");?>
                            </label>
                        ...
                        <div style="text-align: center;">
                            <span><?php echo lang("reg_visit");?>:</span>
                            <?php 
                ...
                <div class="right-side cl-white">
                    <div class="section-header mb-0">
                        <h3 class="title mt-0"><?php echo lang("reg_already_account");?></h3>
                        <p><?php echo lang("reg_login_goto_dashboard");?></p>
                        <a href="<?php echo $this->general->lang_uri('/users/login')?>" class="custom-button transparent"><?php echo lang("log_in");?></a>
                    </div>
                </div>
            </div>
        </div>
