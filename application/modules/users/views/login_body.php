            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header">
                        <h2 class="title"><?php echo lang('login_title');?></h2>
                        <p><?php echo lang('login_short_desc');?></p>
                    </div>
                    <ul class="login-with">
                        <li>
                            <a href="javascript:void(0);" onclick="return facebookLogin();"><i class="fab fa-facebook"></i><?php echo lang("login_facebook");?></a>
                        </li>
                        <li>	
                        <?php /*?><div id="gSignIn"></div><?php */?>
                            <a href="javascript:void(0);" onclick="googlelogin()"><i class="fab fa-google-plus"></i><?php echo lang("login_google");?></a>
                        </li>
                    </ul>
                    <div class="or">
                        <span>Or</span>
        ...
        <i class="fa fa-warning">&nbsp;</i><span id="error_message"></span></div>
                ...
                <div class="right-side cl-white">
                    <div class="section-header mb-0">
                        <h3 class="title mt-0"><?php echo lang("label_are_you_new_title");?></h3>
                        <p><?php echo lang("label_signup_creat_acc");?></p>
                        <a href="<?php echo $this->general->lang_uri('/users/register')?>" class="custom-button transparent"><?php echo lang("sign_up");?></a>
                    </div>
                </div>
            </div>
        </div>
