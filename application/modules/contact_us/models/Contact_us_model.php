...
class Contact_us_model extends CI_Model {
    ...
    public $validate_contact_us = array(
        array('field' => 'fname', 'label' => 'lang:label_ur_name', 'rules' => 'trim|required|max_length[50]'),
        array('field' => 'email', 'label' => 'lang:label_ur_email', 'rules' => 'required|valid_email'),
       // array('field' => 'mobile', 'label' => 'Mobile', 'rules' => 'required|regex_match[/^[0-9+]{10,14}$/]'),
        array('field' => 'message', 'label' => 'lang:label_ur_message', 'rules' => 'trim|required|max_length[300]'),
