<!--============= Banner Section Starts Here =============-->
    ...
    <section class="ending-auction padding-top pos-rel">
        ...
        <div class="container">
            <div class="section-header cl-white">
                ...
                <h2 class="title"><?php echo lang("label_auc_ending_soon_title");?></h2>
                <p><?php echo lang("label_auc_ending_soon_sub_text");?></p>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3">
                            ...
                            <div class="auction-content">
                                ...
                                <div class="bids-area">
                                    <?php echo lang("product_price");?> : <span class="total-bids"><?php
       ...
       <section class="upcoming-auction padding-bottom padding-top">
        <div class="container">
            <div class="section-header">
                <h2 class="title"><?php echo lang("label_upcomming_auc");?></h2>
                <p><?php echo lang("label_upcoming_desc");?></p>
            </div>
        </div>
            ...
            <div class="container">
                <ul class="filter niche-border">
                    <li class="active" data-check="*">
                        <span><i class="flaticon-right-arrow"></i><?php echo lang("label_all");?></span>
                    </li>
                    ...
                    <li data-check=".buy">
                        <span><i class="flaticon-bag"></i><?php echo lang("buy_now");?></span>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="auction-item-7 live <?php echo $is_buy;?> <?php echo $upcomming;?>">
                    <div class="auction-inner">
                            ...
                            <div class="bid-area">
                                <div class="bid-inner">
                                    ...
                                    <div class="bid-amount">
                                        ...
                                        <div class="amount-content">
                                        	<?php if($auc_data->is_buy_now=="Yes"){?>
                                            <div class="current"><?php echo lang("buy_now");?></div>
                                            <div class="amount">
                                            
                                            <?php echo $this->general->formate_price_currency_sign($auc_data->buy_now_price);?>
                                            </div>
                                            <?php }else{?>
                                            <div class="current"><?php echo lang("product_price");?></div>
                                            <div class="amount">
                        ...
                        <div class="auction-bidding">
                            ...
                            <?php }else{?>
                            <a href="<?php echo $item_url; ?>" class="custom-button"><?php echo lang("bid_now");?></a>
                            <?php }?>
                        </div>
                    </div>
                </div>
    ...
    <section class="trending-section padding-bottom padding-top">
        <div class="container">
            <div class="section-header-3">
                ...
                <a href="<?php echo $this->general->lang_uri('/category/' . $this->general->clean_url($category_data['cat_name']) . '-' . $category_data['cat_parent_id']); ?>" class="normal-button"><?php echo lang("lable_view_all");?></a>
            </div>
    ...
    <section class="popular-auction padding-top pos-rel">
        ...
        <div class="container">
            <div class="section-header cl-white">
                <span class="cate"><?php echo lang("label_closing_within_text");?></span>
                <h2 class="title"><?php echo lang("popular_auc_title");?></h2>
                <p><?php echo lang("label_auc_ending_soon_sub_text");?></p>
            </div>
            <div class="popular-auction-wrapper">
                <div class="row mb-30-none">
        ...
        <div class="container">
            <div class="how-wrapper section-bg">
                <div class="section-header text-lg-left">
                    <h2 class="title"><?php echo lang("label_how_it_works");?></h2>
                    <p><?php echo lang("label_hiw_easy_3step");?></p>
                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            ...
                            <div class="how-content">
                                <h4 class="title"><?php echo lang("sign_up");?></h4>
                                <p><?php echo lang("label_nocredit_card_req");?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            ...
                            <div class="how-content">
                                <h4 class="title"><?php echo lang("lable_bid");?></h4>
                                <p><?php echo lang("label_hiw_bid_fee_desc");?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="how-item">
                            ...
                            <div class="how-content">
                                <h4 class="title"><?php echo lang("label_win");?></h4>
                                <p><?php echo lang("label_win_desc");?></p>
                            </div>
                        </div>
                    </div>
                </div>
