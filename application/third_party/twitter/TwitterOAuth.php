...
include(APPPATH.'third_party/twitter/Config.php');
include(APPPATH.'third_party/twitter/Response.php');
include(APPPATH.'third_party/twitter/HmacSha1.php');
include(APPPATH.'third_party/twitter/Consumer.php');
include(APPPATH.'third_party/twitter/Request.php');
include(APPPATH.'third_party/twitter/TwitterOAuthException.php');
include(APPPATH.'third_party/twitter/Token.php');
include(APPPATH.'third_party/twitter/Util/JsonDecoder.php');
...
class TwitterOAuth extends Config
{
    ...
    public function oauth($path, array $parameters = [])
    {
        ...
        if ($this->getLastHttpCode() != 200) {
            //redirect($this->lang_uri('/users/'. end($ci->uri->segment_array())));exit;
    ...
    function lang_uri($path='')
        {           
            ...
            $ci =& get_instance();
            return site_url($ci->uri->segment(1).$path);
            //else
            //return site_url($path);s
        }
