...
var CalPosOffsetX = -198; //X position offset relative to calendar icon, can be negative value
var CalPosOffsetY = -200; //Y position offset relative to calendar icon, can be negative value
