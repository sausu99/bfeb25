...
<tr>
  ...
  <td><input name="price" type="text" class="inputtext" id="price" value="<?php echo set_value('price');?>" size="15" />
      <?=form_error('price')?></td>
  </tr>
<tr>
...
<td class="hmenu_font"> End Date (DD-HH-MM)</td>
    <td>
    <?php //echo set_value('end_day'); 
    $end_day=$this->input->post('end_day'); 
    $end_hour=$this->input->post('end_hour');
    $end_minute=$this->input->post('end_minute');

    ?>
    <input name="end_day" type="text" class="inputtext" placeholder="DD" value="<?php echo !empty($end_day)? $end_day:'';?>" size="10" />
    <?=form_error('end_day')?>
    <input name="end_hour" type="text" class="inputtext" placeholder="HH" value="<?php echo !empty($end_hour)?$end_hour:'';?>" size="10" />
    <?=form_error('end_hour')?>
    <input name="end_minute" type="text" class="inputtext" placeholder="MM" value="<?php echo !empty($end_minute)?$end_minute:'';?>" size="10" />
    <?=form_error('end_minute')?>
    <?=form_error('end_duration')?>
    </td>
</tr>
<tr>
<td class="hmenu_font">Auction Image1 </td>
...
<tr>
<td class="hmenu_font">Auction Image2</td>
...
<tr>
<td class="hmenu_font">Auction Image3</td>
...
<tr>
<td class="hmenu_font">Auction Image4</td>
...
<tr height="30">
  ...
  <td>&nbsp;</td>
  <td colspan="2"><input class="bttn" type="submit" name="Submit" value="Save" /></td>
</tr>
</table>
</form>
