...
<tr>
  ...
  <td width="429"><input name="ip_address" type="text" class="inputtext" id="ip_address" value="<?php echo set_value('ip_address',$data_ip->ip_address);?>" size="30" />
      <?=form_error('ip_address')?></td>
  </tr>

<tr>
  <td width="229" class="hmenu_font">Message</td>
  <td width="429"><textarea name="message" cols="50" class="inputtext" id="message"><?php echo set_value('message',$data_ip->message);?></textarea>
