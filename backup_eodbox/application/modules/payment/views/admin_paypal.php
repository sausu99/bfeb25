<div class="content">
	...
	<h2>Update PayPal Gateway API </h2>
    <div class="mid_frm">
...
<tr>
      ...
      <td><input size="50" class="inputtext" type="text" id="email" name="email" value="<?php echo $payment['email'];?>">
...
<tr>
<td width=229 class="hmenu_font">PayPal Logo:</td>
<td width="429">
