...
<tr>
   ...
   <tr> <td><strong>Access Code:</strong></td><td>
  <input type="text" name="access_code" value="<?php echo $payment['access_code']?>">
     <br />  <?=form_error('access_code');?>
   </td></tr>
   <tr> <td><strong> Working key:</strong></td><td>
      <input type="text" name="working_key" value="<?php echo $payment['working_key']?>">
         <br />  <?=form_error('working_key');?>
   </td></tr>
<tr height=25 valign="middle">
<td align="center">&nbsp;</td>
