...
<tr>
  ...
  <td><input name="code" type="text" class="inputtext" id="code" value="<?php echo set_value('code',$data->code);?>" size="25" />(characters: A-Z, a-z, 0-9 and -)
    <?=form_error('code')?></td>
</tr>
<tr>
  <td><strong>Limit</strong></td>
  <td><input name="limit_number" type="text" class="inputtext" id="limit_number" value="<?php echo set_value('limit_number',$data->limit_number);?>" size="10" />
    <?=form_error('limit_number')?></td>
</tr>
<tr>
  <td width="229"><strong>Limit Per User</strong></td>
  <td width="429"><input name="limit_per_user" type="text" class="inputtext" id="limit_per_user" value="<?php echo set_value('limit_per_user',$data->limit_per_user);?>" size="10" />
      <?=form_error('limit_per_user')?></td>
  </tr>

<?php /*?><tr height="30">
  <td><strong>Free Bids</strong></td>
  <td colspan="2"><input name="free_bids" type="text" class="inputtext" id="free_bids" value="<?php echo set_value('free_bids',$data->free_bids);?>" size="10" />(Registration Voucher)
    <?=form_error('free_bids')?></td>
</tr><?php */?>
<tr height="30">
  <td><strong>Extra Bids</strong>(%)</td>
  <td colspan="2"><input name="extra_bids" type="text" class="inputtext" id="extra_bids" value="<?php echo set_value('extra_bids',$data->extra_bids);?>" size="10" />
    <?=form_error('extra_bids')?></td>
</tr>
<tr height="30">
  <td><strong>Start Date</strong></td>
  <td colspan="2"><input name="start_date" type="text" class="inputtext" id="start_date" value="<?php echo set_value('start_date',$data->start_date);?>" size="10" readonly="readonly" />
...
<tr height="30">
  ...
  <td colspan="2"> <input name="end_date" type="text" class="inputtext" id="end_date" value="<?php echo set_value('end_date',$data->end_date);?>" size="10" />
