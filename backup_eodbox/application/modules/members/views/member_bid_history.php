                                        ...
                                        <table width='100%'  height='90%' border='0' cellpadding='0' cellspacing='0'>
                                            ...
                                            <tr> 
                                                <td> 
                                                    ...
                                                    <table  class="contentbl" width="99%" border="0" align="left" cellpadding="2" cellspacing="2">
                                                        <tr>
                                                        ...
                                                        if ($result_data) {
                                                            foreach ($result_data as $data) {
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <?php echo $profile->user_name; ?> has not placed any bids in closed standard auctions.
                                                                <? }?>
                                                            </td>  
                                                        </tr>	  
