...
<td>
 <select name="type" style="width:142px; padding:2px 0px 2px 5px;">
  ...
  <option value="home" <?php if($result_data->type=='home')echo 'selected';?>>Home</option>
  <option value="tv_show"  <?php if($result_data->type=='tv_show')echo 'selected';?>>Tv show</option>
...
<tr>
  ...
  <td><input type="text" name="url" id="url" value="<?php echo $result_data->url;?>" />(Ex.: http://www.example.com)</td>
</tr>
<tr>
  <td class="hmenu_font">&nbsp;</td>
  <td> <img src="<?php print(site_url(BANNER_PATH.$result_data->banner));?>" width="300" height="100" /></td>
</tr>
<tr>
<td width=229 class="hmenu_font">Banner<span class="error">*</span></td>
<td width="429"><input name="banner" type="file" id="banner" />(Size 1920px X 590px)
