...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="contentbl">
  ...
  <tr> 
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>Name</td>
        <td width="412" style="border-right:none;"><?php echo $auc_name->name?></td>
      </tr>
      ...
      <tr>
        <td width="164">Shipping Cost </td>
        <td align="left" style="border-right:none;"><?php echo $this->general->formate_price_currency_sign_admin($won_details->country,$won_details->shipping_cost);?></td>
      </tr>
      <tr>
        <td><strong>Total Amount </strong></td>
        <td align="left" style="border-right:none;"><strong><?php echo $this->general->formate_price_currency_sign_admin($won_details->country,$won_details->amount);?></strong></td>
      </tr>
      
      <tr>
        <td><strong>Payment Method</strong></td>
        <td align="left" style="border-right:none;"><strong><?php echo $won_details->payment_method;?></strong></td>
      </tr>
    </table></td>
    <td align="left" valign="top" style="border-right:none;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td style="border-right:none;"><strong>
          <?php echo $won_details->transaction_status;?>
          </strong></td>
      </tr>
      <tr>
        <td><strong>Payment Date </strong></td>
        <td style="border-right:none;"><strong>
          <?php if(isset($won_details->transaction_date)) echo $this->general->convert_local_time($won_details->transaction_date); else echo 'NA';?>
        </strong></td>
      </tr>
      <tr>
        <td><strong>Shipping Status  </strong></td>
        <td style="border-right:none;"><strong>
          <?php if($winner_address->buy_auc_shipping_status == 2) echo 'Shipped'; else echo 'Not Shipped';?>
        </strong></td>
      </tr>
    </table></td>
    </tr>
    ...
    <table border="0" cellspacing="4" cellpadding="4">
      <tr>
		...
		<select name="shipping">
			...
			<option value="1" <?php if($winner_address->buy_auc_shipping_status ==1){echo 'selected="selected"';}?>>Not Shipped</option>
			<option value="2" <?php if($winner_address->buy_auc_shipping_status ==2){echo 'selected="selected"';}?>>Shipped</option>
		</select>
		
		</td>
      </tr>
      <tr>
        <td>&nbsp;<input type="hidden" name="invoice_id" value="<?php echo $won_details->invoice_id;?>" /></td>
