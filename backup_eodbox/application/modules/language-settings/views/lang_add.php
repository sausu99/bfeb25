...
<tr>
  ...
  <td><input name="lang_name" type="text" class="inputtext" id="lang_name" value="<?php echo set_value('lang_name');?>" size="20" />
      <?=form_error('lang_name')?></td>
  </tr>
<?php /*?><tr>
  <td class="hmenu_font">Language Short Code </td>
  <td><input name="short_code" type="text" class="inputtext" id="short_code" value="<?php echo set_value('short_code');?>" size="10" />
    <?=form_error('short_code')?></td>
</tr>
<tr>
  <td class="hmenu_font">Currency Code </td>
  <td><input name="currency_code" type="text" class="inputtext" id="currency_code" value="<?php echo set_value('currency_code');?>" size="10" />
    <?=form_error('currency_code')?></td>
</tr>
<tr>
  <td class="hmenu_font">Currency Sign </td>
  <td><input name="currency_sign" type="text" class="inputtext" id="currency_sign" value="<?php echo set_value('currency_sign');?>" size="10" />
...
<td width="429"><input name="flag" type="file" id="flag" />(Size 16px X 11px)
...
<tr>
  ...
  <input name="is_display" type="radio" value="Yes" checked="checked" />
    Yes
      <input name="is_display" type="radio" value="No" <?php echo set_radio('is_display', 'No'); ?> <?php //if($site_set['is_display'] == 'No'){ echo 'checked="checked"';}?> />
      No
  </td>
</tr>
<?php /*?><tr>
  ...
  <input name="display_in" type="radio" value="Left" checked="checked" />
    Left Side
      <input name="display_in" type="radio" value="Right" <?php echo set_radio('display_in', 'No'); ?><?php //if($site_set['display_in'] == 'Right'){ echo 'checked="checked"';}?> />
      Right Side
  </td>
</tr><?php */?>
