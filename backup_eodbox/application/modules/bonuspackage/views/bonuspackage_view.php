...
<div style="padding:6px 20px; float:left; width:610px; background:#202020; color:#ABABAB;"><span class="breed"><a href="<?=site_url(ADMIN_DASHBOARD_PATH)?>">ADMIN</a> &raquo; Bonus Point Management </span></div>
	...
	<h2>View Bonus Point Package Details </h2>
    <div class="mid_frm">
    
      <table width="100%">
        <tr>
          <td><strong>[ <a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/bonuspackage/add_bonuspackage">Add Bonus Package </a> ]</strong></td>
        </tr>
      </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="contentbl">
  <tr> 
    <th align="left">Bonus Point Package Name </th>
    <th align="left">Bonus Point </th>
  ...
  <tr> 
    ...
    <td align="left"><div align="left"><?php print($bp_val->bonus_points);?></div></td>
    <td align="left"><?php print($bp_val->credits);?></td>
    <td align="left"><?php print($bp_val->last_update);?></td>
    <td align="center"><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/bonuspackage/edit_bonuspackage/<?php print($bp_val->id);?>">
      <img src='<?php print(ADMIN_IMG_DIR_FULL_PATH);?>/edit.gif' title="Edit"></a> </td>
    <td align="center" style="border-right:none;"><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/bonuspackage/delete_bonuspackage/<?php print($bp_val->id);?>"> 
