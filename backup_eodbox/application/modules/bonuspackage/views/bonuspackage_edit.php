...
<tr>
  <td class="hmenu_font">Bonus Point </td>
  <td><input name="bonus_points" type="text" class="inputtext" id="bonus_points" value="<?php echo set_value('bonus_points',$data->bonus_points);?>" size="10" />
