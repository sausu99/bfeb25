...
<div style="padding:6px 20px; float:left; width:610px; background:#202020; color:#ABABAB;"><span class="breed"><a href="<?=site_url(ADMIN_DASHBOARD_PATH)?>">ADMIN</a> &raquo; How it Works Management </span></div>
	...
	<h2>View How it Works Details </h2>
    <div class="mid_frm">
    
     
		  <div style="background:#FFFFFF; border:1px dashed #333333; padding:10px 5px; margin:10px 0 10px 0;">
		  <strong>[ <a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/how-it-works/add_banner">Add How it Works </a> ]</strong>
		  </div>
		  ...
		  <ul id="vList">		   
		   <?php
				...
				{
		?>
		  <li>[ <?php if($lang_id != $lang->id){?><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/how-it-works/index/<?php echo $lang->id;?>"><?php }?><?php echo $lang->lang_name;?></a> ]</li>
		 <?php
		 		}
		?>
		  </ul>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="contentbl">
  ...
  <th align="center">Banner</th>
	...
	?>
  <tr> 
    <td align="left"><div align="center"><img src="<?php echo base_url().$data->banner;?>" width="400" height="100"></div></td>
    <td align="center"><?php print($data->is_display);?></td>
    <td align="center"><?php print($data->last_update);?></td>
    <td align="center"><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/how-it-works/edit_banner/<?php print($data->id);?>/<?php print($data->lang_id);?>">
      <img src='<?php print(ADMIN_IMG_DIR_FULL_PATH);?>/edit.gif' title="Edit"></a> </td>
    <td align="center" style="border-right:none;"><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/how-it-works/delete_banner/<?php print($data->id);?>"> 
