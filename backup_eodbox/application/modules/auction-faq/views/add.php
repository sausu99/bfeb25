...
<div class="content">
	...
	<h2><?php echo $jobs;?> Auction FAQ's </h2>
    <div class="mid_frm">
...
<tr>
  <td valign="top"><strong>Choose Auction</strong></td>
  <td>
  <?php
  ...
  <?php foreach($this->admin_faq->get_auction_bylangid($lang_details[$i-1]->id) as $help_cat){?>
  <option value="<?php echo $help_cat->id;?>" <?php if(isset($hlep_category) && $hlep_category[$lang_details[$i-1]->id] == $help_cat->id ) {echo 'selected="selected"';} ?>><?php echo $help_cat->name;?></option>
  <?php }?>
  </select>
...
<tr>
      <td width="288" valign="top"><strong> Title</strong></td>
      <td width="838">
...
<tr height=25 valign="middle">
  <td colspan="2">
        ...
        <textarea rows="5" cols="80" name="<?php echo 'description['.$lang_details[$i-1]->id.']';?>"><?php echo $description;?></textarea>
