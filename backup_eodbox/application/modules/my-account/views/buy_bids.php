...
<div class="dashboard-widget mb-40">
                        <div class="dashboard-title mb-30">
                            <h5 class="title">Never run out of Credits, Buy Credits now!</h5>
                        </div>
                        <?php
                    ...
                    foreach ($bid_packages as $package) {
                        ...
                        <div class="dashboard-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="info">Bid Credit: <?php echo $package->credits; ?> | Bonus: <?php echo $package->bonus_points; ?> | Validity: Unlimited</h6>
                                    </div>
                                </div>
                ...
                ?>
                    ...
                    <div class="dashboard-widget">
                        <h5 class="title mb-10">Your bid credit purchase statement</h5>
                        <div class="dashboard-purchasing-tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <?php }?>
                                    ...
                                    <div style="font-style: italic; font-size: 11px; font-weight: bold; color: #9a7ef2;">To View your Bid Credit history, check your statement in <a href="<?php echo $this->general->lang_uri('/'.MY_ACCOUNT.'/user/purchases') ?>">My Purchase History</a> section</div>
                                    <?php //}?>
                                </div>
                            </div>
                        </div>
