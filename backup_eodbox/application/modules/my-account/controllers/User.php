...
class User extends CI_Controller {
    ...
    public function index() {
		...
		$this->data['account_page_name'] = 'Dashboard';
    ...
    public function edit() {
		...
		$this->data['account_page_name'] = 'Personal Profile';
	...
	public function mobile() {
		...
		$this->data['account_page_name'] = 'Personal Mobile';
		...
		if($this->input->server('REQUEST_METHOD') === 'POST' && $this->input->post('mobile')==$this->input->post('mobile_old')){
			$this->session->set_flashdata('error_message', 'There is no any changes in your existing mobile.');
        ...
        if ($this->form_validation->run() == TRUE) {
			...
			$this->session->set_flashdata('success_message', 'Your mobile number is update successfully.');
        ...
        $this->page_title = 'Personal Mobile' . ' | ' . SITE_NAME;
        $this->data['meta_keys'] = '';
        $this->data['meta_desc'] = '';
    ...
    public function refer() {
		...
		$this->data['account_page_name'] = 'Refer A Friend';
    ...
    public function wonauctions() {
		...
		$this->data['account_page_name'] = 'My Winning Bids';
    ...
    public function ongoing_auction() {
		...
		$this->data['account_page_name'] = 'My Bids';
	...
	public function bid_statement() {
        ...
        $this->data['account_menu_active'] = 'ongoing_auction';
		$this->data['account_page_name'] = 'My My Bids Statement';
    ...
    public function watchlist() {
		...
		$this->data['account_page_name'] = 'Favorite Auctions';
		$user_id = $this->session->userdata(SESSION . 'user_id');
		//get user watchlist
		$this->data['user_watchlist'] = $this->general->get_user_watchlist($user_id);
        ...
        $this->page_title = SITE_NAME . ' | ' . lang('watch_list');
    ...
    public function purchases() {
        ...
        $this->template
                ->set_layout('account')
                ->enable_parser(FALSE)
                ->title('Purchase History | ' . SITE_NAME)
    ...
    public function buybids() {
        ...
        $this->data['account_menu_active'] = 'buybids';
		$this->data['account_page_name'] = 'Bid Credits';
    ...
    public function bonuspackage() {
		...
		$this->data['account_page_name'] = 'Redeem Bonus Points';
        ...
        $this->template
                ->set_layout('account')
                ->enable_parser(FALSE)
                ->title('Redeem Bonus Points | ' . SITE_NAME)
                ->build('bonus_package_lists', $this->data);
    }

    public function cancel() {
        $this->data['account_menu_active'] = 'cancel';
		$this->data['account_page_name'] = 'Cancel Account';
        ...
        $this->template
                ->set_layout('account')
                ->enable_parser(FALSE)
                ->title('Cancel Account | ' . SITE_NAME)
...
//        $json = json_encode($_POST);
    ...
    public function buyauctions() {
		...
		$this->data['account_page_name'] = 'My Buy Auctions';
