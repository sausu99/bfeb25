...
//                    $this->email->send();
	...
	function send_opt_code($opt_code,$user_mobile){
		...
		$message = urlencode("Dear Customer, Welcome to www.eodbox.com. Please use ".$opt_code." as OTP for your mobile number verification. Eodbox.com - The most transparent & rewarding Bidding platform of India. OTP Valid for 2 hours only.");
