                ...
                <div class="col-lg-4">
                    <div class="product-sidebar-area">
                        ...
                        <div class="buy-now-area">
                            ...
                            <a href="javascript:void(0)" class="rating custom-button active border" data-productid='<?php echo $auc_data->product_id; ?>'  ><i class="fas fa-star with_<?php echo $auc_data->product_id; ?> <?php echo $watchclass; ?>"></i> Add to Favorites</a>
