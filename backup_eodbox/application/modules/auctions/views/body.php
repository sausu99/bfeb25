                ...
                <div class="col-lg-4">
                    <div class="product-sidebar-area">
                        ...
                        <div class="buy-now-area">
                            ...
                            <a href="javascript:void(0)" class="rating custom-button active border wthlst <?php echo $watchclass; ?>" data-productid='<?php echo $auc_data->product_id; ?>'  ><i class="fas fa-star with_<?php echo $auc_data->product_id; ?> <?php echo $watchclass; ?>"></i> Add to Favorites</a>
                ...
                <div class="col-lg-8">
                    <div class="product-details-content">
                        <div class="product-details-header">
                            ...
                            <ul>
                                <li>Listing ID: <?php echo $auc_data->id; ?></li>
                                <li>Item #: <?php echo $auc_data->product_id; ?></li>
                            </ul>
                            <hr class="mb-4">
                        </div>
                        ...
                        <div class="product-bid-area">
                            ...
                            <div class="container">
                                <form method="post" action="" class="product-bid-form" id="singleBidForm">
                                    ...
                                    <button class="custom-button" id="singleBidBtn">Submit your bid</button>
                                    <input type="hidden" name="auc_id" value="<?php echo $auc_data->product_id; ?>" />
                                <?php } else { ?>
                                    <a class="custom-button" href="<?php echo $this->general->lang_uri("/users/login"); ?>">Submit your bid</a>
                                <?php } ?>
                        ...
                        <div class="product-bid-area">
                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-12">
                                <?php if ($this->session->userdata(SESSION . 'user_id')) { ?>
                                    <button class="custom-button" id="multiBidBtn">Submit your bid in this Range</button>
                                    <input type="hidden" name="auc_id" value="<?php echo $auc_data->product_id; ?>" />
                                <?php } else { ?>
                                    <a class="custom-button" href="<?php echo $this->general->lang_uri("/users/login"); ?>">Submit your bid in this Range</a>
                                <?php } ?>
                                </div>
                                </form>
                            </div>
                ...
                <ul class="product-tab-menu nav nav-tabs">
                    ...
                    <li>
                        <a href="#MyBidHistory" data-toggle="tab">
                            ...
                            <div class="content">My Bid History (<span id="total_bid_hist"><?php if($total_records){?><?php echo $total_records;?><?php }else{ echo '0';}?></span>)</div> <!--This section relates to total number of bids placed by the user on this listing-->
                        </a>
                    </li>
                    <li>
                        <a href="#OtherBidHistory" data-toggle="tab">
                            ...
                            <div class="content">Others Bid History <?php if($total_records_other){?>(<?php echo $total_records_other;?>)<?php }?></div> <!-- The number should be of the total number of bids on this auction listing-->
                        </a>
                    </li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show" id="MyBidHistory">
                    <div class="shipping-wrapper">
                        <div class="item">
                            <h5 class="title">My Bid History</h5>
                            <Span>Refresh</Span>
                        </div>
                        <!-- <div class="item">
                ...
                <div class="tab-pane fade show" id="OtherBidHistory">
                    <div class="history-wrapper">
                        <div class="item">
                            <h5 class="title">Other Bidders Bid History</h5>
                            Recent 10 Bidders
