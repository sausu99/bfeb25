<div class="content">
	...
	<h2>Update Content Management System  </h2>
    <div class="mid_frm">
...
<tr>
<td>
<select name="lang" onchange="redirect_lang_cms()" id="lang">
...
<tr>
<td><input size="50" class="inputtext" type="text" id="headtext" name="headtext" value="<?php echo set_value('headtext',$cms_data['heading']);?>">
...
<tr>
<td><input size="50" class="inputtext" type="text" id="cms_slug" name="cms_slug" value="<?php echo set_value('cms_slug',$cms_data['cms_slug']);?>">(Ex.:about-us <strong>or</strong> how-it-works)
...
<td>
		<?php
			 if($this->input->post('content')){$content_data=$this->input->post('content');}else{$content_data=$cms_data['content'];}
...
<?php if($cms_data['video_file']){?>

  
  <td>
                                            <video width="100%" poster="" controls>
                                                <source src="<?php echo base_url(BANNER_PATH . $cms_data['video_file']); ?>" type="video/mp4">
                                                <!--<source src="<?php //echo base_url(BANNER_UPLOAD_DIR . $values->file_name); ?>" type="video/ogg">-->
                                            	...
                                            	<a style="margin-left:5px;" href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/cms/delete_vid/'.$cms_data['id'].'/'.$cms_data['parent_id'])?>">
       <img src="<?php print(ADMIN_IMG_DIR_FULL_PATH);?>/delete.gif" title="Delete"></a>
   ...
   <tr>
                           <td> <label>Select Video File</label></td></tr>
...
<tr>
<td><textarea cols="60" rows="1" id="page_title" name="page_title"><?php echo set_value('page_title',$cms_data['page_title']);?></textarea>
...
<tr>
<td>
<textarea cols="60" rows="2" id="meta_description" name="meta_description"><?php echo set_value('meta_description',$cms_data['meta_description']);?></textarea>
...
<tr>
      <td ><strong>Display:</strong>
        ...
        <input name="status" type="radio" value="No" <?php if($cms_data['is_display']=='No')echo 'checked';?> /> No
      <br />      
	  <?=form_error('status')?>
	  </td>
</tr>
...
{
	if($('#lang').val())
		document.location.href="<?php echo base_url().ADMIN_DASHBOARD_PATH.'/cms/edit/'.$this->uri->segment(4).'/';?>"+$('#lang').val();
}
</script>