            ...
            <div class="container">
                <div class="copyright-area">
                    <div class="footer-bottom-wrapper">
                        ...
                        <div class="copyright"><p>&copy; Copyright <?php echo date("Y");?> | <a href="<?php echo site_url();?>">EODBOX</a> By <a href="https://www.emultitechsolution.com/">E-multitechsolution Pvt.Ltd.</a></p></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  $(document).ready(function() {
    ...
    $("#subscribe").validate({
      submitHandler: function(form) {
       ...
       var input = $("#semail").val();
		   //alert(input);
		   $.post(SUBSCRIBE_URL,{email:input},function(result){	
		  		// console.log(result);	   
         $(".form_validation_error").html(result);				
         $("#semail").val('');
       });
     },
     errorElement: "div",
