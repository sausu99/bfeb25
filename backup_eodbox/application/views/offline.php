...
<body>
	<section class="off_wrapper">
		...
		<div class="off_body">
			<div class="visit">
				<span class="avail_stat_txt"><?php if(isset($offline_msg->heading))echo $offline_msg->heading;?></span>
				<span><?php if(isset($offline_msg->content))echo $offline_msg->content;?></span>
